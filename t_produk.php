...
// 1. Cek validasi login user
if (!isset($_SESSION["login"])) {
    header("Location: login.php");
    exit;
}

// 2. Logika Pembuatan Kode Produk Otomatis (P001, dst)
...
// 3. Proses Simpan Data (ketika form disubmit)
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        if (move_uploaded_file($tmp_file, $dir . $imgnewfile)) {
            ...
            if ($query) {
                ...
                echo "<script>alert('Gagal menambahkan produk ke database!'); window.location='produk.php';</script>";
                exit;
            }
        } else {
...
<head>
    ...
    <title>Data Produk - Berkatti</title>
...
<body>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            <h6><?= isset($_SESSION['name']) ? $_SESSION['name'] : 'User'; ?></h6>
                            <span><?= isset($_SESSION['role']) ? $_SESSION['role'] : 'Role'; ?></span>
                        </li>
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" method="post" enctype="multipart/form-data">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="kd_produk" name="kd_produk" value="<?= $kd_produk; ?>" readonly>
                                </div>
                                <div class="col-12">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Berkatti</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            Designed by <a href="#">Reno Saputra</a>
        </div>
    </footer>
